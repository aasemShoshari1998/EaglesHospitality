...
Route::get('/shop/skin-care', function (Request $request) {
...
Route::get('/shop/personal-care', function (Request $request) {
...
Route::get('/shop/body-care', function (Request $request) {
...
Route::get('/shop/extra-care', function (Request $request) {
