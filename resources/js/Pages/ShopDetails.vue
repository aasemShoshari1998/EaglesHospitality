            ...
            <section class="row g-4">
                <article class="col-lg-6">
                    <article class="border rounded">
                        ...
                        >
                            <img
                                :src="props.product[0].imageUrl"
                                class="img-fluid rounded productImg"
                                width="400"
                                height="400"
                                :alt="locale == 'en'? 'Product image' : 'صورة المنتج'"                            />
                            <p
                                class="align-self-start ms-5 mt-3 colorOrange fw-bold"
                            >
                                {{
                ...
                <aside class="row d-flex justify-content-between marginTopHalf">
                    <article class="mb-3">
                        ...
                        <article
                            ...
                            class="row mt-5 border-bottom-1 pb-5 border-secondary"
                        >
                            <article class="col-md-6 d-flex gap-4 py-5">
                                <img
                                    :src="review.imageUrl"
                                    class="reviewImg col-md-2"
                                    :alt="locale == 'en'? 'User image' : 'صورة المستخدم'"
                                    width="50"
                                    height="50"
                                />
                                <p>
                                    ...
                                    />
                                    <p
                                        class="text-muted mt-4 text-break"
                                    >
                                        {{ review.review }}
                                    </p>
                                </p>
                ...
                <form @submit.prevent="submit(props.product[0].id)">
                    ...
                    <section class="row g-4">
                        <article class="col-lg-6">
                            <article class="border-bottom rounded">
                                <input
                                    ...
                                    :placeholder="$t('profile.profileInfoName')"
                        ...
                        <aside class="col-lg-12">
                            <article
                                class="d-flex justify-content-between py-3 mb-5"
                            >
