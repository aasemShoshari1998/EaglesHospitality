...
onMounted(() => {
    ...
    img.forEach((e) => (e.parentElement.style.height = "240px"));
});
...
<template>
    ...
    <section class="container-fluid vesitable marginTopHalf bgBlueish">
                ...
                <article>
                    ...
                    >
                        <swiper-slide v-for="product in props.products">
                            <div
                                class="d-flex flex-column align-items-center px-md-4"
                            >
                                <div>
                                    <Link
                                        type="button"
                                ...
                                <div class="overflow-hidden">
                                    <p
                                        class="text-white fw-normal text-sm text-break"
                                        style="
                                            max-width: 200px;
                                            max-height: 160px;
                                        "
