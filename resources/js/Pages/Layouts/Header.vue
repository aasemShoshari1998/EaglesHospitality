...
<template>
    <header class="fixed-top" style="z-index: 50">
        ...
        />
        <aside
            class="d-none d-md-flex justify-content-between p-md-4 bgBlueish text-center"
        >
        ...
        <nav class="container-fluid p-0">
            <nav
                dir="ltr"
                class="navbar navbar-light bg-white navbar-expand-xl px-3 h-100"
            >
                <Link class="navbar-brand" :href="$route('home')">
                    <img
                        src="../../../../public/logo.jfif"
                        :alt="locale == 'en' ? 'Website logo' : 'شعار الموقع'"
                        class="logoImg"
                        width="100"
                        height="100"
                    />
                ...
                >
                    <span class="fa fa-bars colorBlueish"></span>
                </button>
                <nav
                ...
                >
                    ...
                    >
                        <NavLink
                            :href="$route('home')"
                            class="nav-item nav-link js-scroll-trigger colorBlueish mx-2 fw-bold"
                        ...
                        <menu class="dropdown">
                            <NavLink
                                class="nav-item nav-link dropdown-toggle colorBlueish mx-2 fw-bold"
                                type="button"
                    ...
                    <aside class="d-flex align-items-center p-2">
                        <a
                            class="borderBlueish me-1 border-none bgBlueish px-2 py-1 rounded-circle text-white hoverColorWhiteBgLightBlueish"
                            href="#"
                        ...
                        >
                            ...
                            <button
                                type="button"
                                class="btn colorBlueish hoverColorBlueish"
                                data-bs-toggle="dropdown"
                                aria-expanded="false"
                                v-if="$page.props.auth.user?.isAdmin"
                            >
                            ...
                            <menu
                                class="dropdown-menu notificationDropdown p-0"
                                :class="[locale === 'en' ? 'null' : 'text-end']"
                                v-if="$page.props.auth.user?.isAdmin"
                            >
                                <li
                                    v-for="contact in contacts"
                                    class="d-flex gap-3 p-2 border-bottom cursorPointer colorBlueish"
                                    :class="[
                                        contact.delivered
                                            ? null
                                            : 'unReadContact',
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body d-flex align-items-center">
                    <div
                        class="modalSearch position-relative input-group w-75 mx-auto"
                    >
                        <input
                            type="search"
                        ...
                        <div class="filterProducts">
                            <ul class="navy bg-white m-0 mb-4 p-0">
                                <li
                                    ...
                                    class="js-scroll-trigger mt-3 hoverSearchItem"
                                    data-bs-dismiss="modal"
                                >
                                    <Link
                                        as="button"
                                        ...
                                        <img
                                            ...
                                            :alt="
                                                locale == 'en'
                                                    ...
                                                    : 'صورة المنتج'
                                            "
                                            class="js-scroll-trigger reviewImg"
                                            width="50"
                                            height="50"
                                        />
                                        <p
                                            class="js-scroll-trigger colorBlueish"
                                        >
                                            {{ product.name }}
                                        </p>
                                    </Link>
